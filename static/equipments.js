...
var checkboxValues = JSON.parse(localStorage.getItem('equipmentsCheckboxValues'));
...
function saveCheckBoxStateToLocalStorage() {
    ...
    localStorage.setItem("equipmentsCheckboxValues", JSON.stringify(checkboxValues));
}
